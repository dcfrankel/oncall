...
@patch("lib.jira_service_management.resources.integrations.JIRA_SERVICE_MANAGEMENT_FILTER_TEAM", "team1")
...
@patch("lib.jira_service_management.resources.integrations.JIRA_SERVICE_MANAGEMENT_FILTER_TEAM", None)
@patch(
    "lib.jira_service_management.resources.integrations.JIRA_SERVICE_MANAGEMENT_FILTER_INTEGRATION_REGEX", "^Prod.*"
)
...
@patch("lib.jira_service_management.resources.integrations.JIRA_SERVICE_MANAGEMENT_FILTER_TEAM", None)
@patch("lib.jira_service_management.resources.integrations.JIRA_SERVICE_MANAGEMENT_FILTER_INTEGRATION_REGEX", None)
