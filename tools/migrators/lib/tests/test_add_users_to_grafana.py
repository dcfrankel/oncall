...
@patch("lib.jira_service_management.api_client.JiraServiceManagementAPIClient")
@patch("lib.grafana.api_client.GrafanaAPIClient")
@patch("sys.exit")
@patch.dict(
    "os.environ",
...
def test_migrate_all_jira_service_management_users(
    mock_exit, mock_grafana_client_class, mock_jira_service_management_client_class
):
    mock_jira_service_management_instance = mock_jira_service_management_client_class.return_value
    mock_jira_service_management_instance.list_users.return_value = [
        {"id": "USER1", "fullName": "User One", "username": "user1@example.com"},
        {"id": "USER2", "fullName": "User Two", "username": "user2@example.com"},
        {"id": "USER3", "fullName": "User Three", "username": "user3@example.com"},
    ]
...
@patch.dict(
    "os.environ",
    {
        ...
        "GRAFANA_USERNAME": "test_user",
        "GRAFANA_PASSWORD": "test_pass",
        "JIRA_SERVICE_MANAGEMENT_FILTER_USERS": "USER1,USER3",
    },
)
def test_migrate_filtered_jira_service_management_users(
    mock_exit, mock_grafana_client_class, mock_jira_service_management_client_class
):
    mock_jira_service_management_instance = mock_jira_service_management_client_class.return_value
    mock_jira_service_management_instance.list_users.return_value = [
...
def test_jira_service_management_error_handling(
    mock_exit, mock_grafana_client_class, mock_jira_service_management_client_class
):
    mock_jira_service_management_instance = mock_jira_service_management_client_class.return_value
    mock_jira_service_management_instance.list_users.return_value = [
...
def test_jira_service_management_user_already_exists(
    mock_print, mock_exit, mock_grafana_client_class, mock_jira_service_management_client_class
):
    mock_jira_service_management_instance = mock_jira_service_management_client_class.return_value
    mock_jira_service_management_instance.list_users.return_value = [
        {"id": "USER1", "fullName": "User One", "username": "user1@example.com"}
